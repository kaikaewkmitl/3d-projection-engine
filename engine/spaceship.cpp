...
public:
    ...
    Engine()
    {
        ...
        this->spaceship.loadFromFile("spaceship.obj");
...
void callback(Canvas *c)
{
    ...
    for (auto &tri : e->spaceship.tris)
    {
        ...
        // how far away the spaceship is
        triTranslated = triRotatedZX;
        triTranslated.p[0].z += 5.8f;
        triTranslated.p[1].z += 5.8f;
        triTranslated.p[2].z += 5.8f;
        ...
        if (dotProduct < 0.0f)
        {
            ...
            triProjected.p[0].x *= 0.5f * e->width;
            triProjected.p[1].x *= 0.5f * e->width;
            triProjected.p[2].x *= 0.5f * e->width;

            triProjected.p[0].y *= 1.0f * e->height;
            triProjected.p[1].y *= 1.0f * e->height;
            triProjected.p[2].y *= 1.0f * e->height;
